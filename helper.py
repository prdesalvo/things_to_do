...
def the_knot_places(city):
    ...
    places = pd.DataFrame(columns=[
        'heading', 'description', 'place_image', 'site', 'place',
                ...
                for i in elements:
                    if 'h' in i.name:
                        ...
                        places.loc[len(places)] = [
                            heading_for_place, description, image_for_place,
                            poi_link, city, couples_names, wedding_date
                        ]
                    else:
                        pass
            else:
    ...
    #removes some random sites
    filt = places['couples_names'] != ''
    places = places.loc[filt]

    results = places.groupby([
        'heading', 'site', 'place', 'place_image', 'couples_names',
        'wedding_date'
